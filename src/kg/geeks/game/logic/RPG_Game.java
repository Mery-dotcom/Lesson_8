...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Boss boss = new Boss(1800, 50, "Skeleton");
        ...
        Antman antman = new Antman(200, 8, "Antman");
        Ludoman ludoman = new Ludoman(180, 4, "Ludoman");
        Avenger avenger = new Avenger(180, 2, "Stone");

        Hero[] heroes = {warrior1, doc, warrior2, magic, berserk, assistant, antman, ludoman, avenger};
